...
namespace WashingCarDB.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumberPlate,VehicleDetailsId,Id,CreateDate,ModifieDate")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("NumberPlate,VehicleDetailsId,Id,CreateDate,ModifieDate")] Vehicle vehicle)
        {
            if (id != vehicle.Id)
            {
                return NotFound();
