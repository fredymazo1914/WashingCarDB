...
namespace WashingCarDB.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Price,VehicleId,Id,CreateDate,ModifieDate")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Price,VehicleId,Id,CreateDate,ModifieDate")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
